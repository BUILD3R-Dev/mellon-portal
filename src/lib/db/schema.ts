...
export const tenantBranding = pgTable('tenant_branding', {
  ...
  tenantLogoDarkUrl: text('tenant_logo_dark_url'),
  tenantLogoDarkData: text('tenant_logo_dark_data'),
  tenantLogoDarkContentType: varchar('tenant_logo_dark_content_type', { length: 50 }),
